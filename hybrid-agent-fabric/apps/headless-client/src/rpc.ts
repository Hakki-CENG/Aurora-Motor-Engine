  ...
  async handle(request: JsonRpcRequest): Promise<JsonRpcResponse | undefined> {
    ...
    try {
      ...
      switch (request.method) {
        case "initialize":
          result = { protocolVersion: 1, clientInfo: { name: "haf-headless-client", version: "1.38.0" }, capabilities: { sessions: true, commands: true, eventSubscriptions: true, approvals: true } };
          break;
