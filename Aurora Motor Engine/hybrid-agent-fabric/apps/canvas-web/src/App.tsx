...
type Tab = "chat" | "terminal" | "files" | "changes" | "browser" | "media" | "artifacts" | "tree" | "tasks" | "models" | "profiles" | "mcp" | "secrets" | "channels" | "learning" | "automations";
...
export function App() {
  ...
  const tabs: Array<[Tab, any, string]> = [
    ...
    ["changes", GitBranch, "Changes"], ["browser", Globe2, "Browser"], ["media", Video, "Media"], ["artifacts", Boxes, "Artifacts"], ["tree", Workflow, "Tree"], ["tasks", ListTodo, "Tasks"], ["models", Code2, "Models"], ["profiles", Bot, "Profiles"], ["mcp", Workflow, "MCP"], ["secrets", KeyRound, "Secrets"], ["channels", Send, "Channels"], ["learning", RefreshCw, "Learning"], ["automations", Boxes, "Automations"],
  ];
